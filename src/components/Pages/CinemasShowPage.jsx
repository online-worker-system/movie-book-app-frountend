        ...
        <div className="px-12 flex flex-col gap-3">
          ...
          <div className="flex gap-2">
            {movieDetailes?.genres?.map((lang, index) => (
              <div
                key={index}
                className="text-xs py-[2px] px-3 xl:px-4 text-gray-600 border border-gray-500 rounded-2xl"
              >
                <p>{lang}</p>
              </div>
            ))}
          ...
          <div className="px-8 py-3 bg-white">
            <div className="mb-2 flex justify-end items-center gap-3">
              ...
              <div className="flex gap-2 items-center">
                ...
                <div className="text-gray-400 text-xs">FAST FILLING</div>
              </div>
              <div className="flex gap-2 items-center">
                <div className="px-1 border border-green-500 text-green-500 text-[8px]">
                  LAN
                </div>
                <div className="text-gray-400 text-xs">SUBTITLES LANGUAGE</div>
              </div>
            </div>
            {cinemas?.map((cinema) => (
              <div className="border-t-[1px] py-4 flex items-center gap-16">
                <div className="text-sm font-medium">
                  <div className="mb-3 cursor-pointer hover:underline">{cinema?.cinemaName}</div>
                  <div className="flex gap-6">
                    <div className="flex">
                      ...
                      <div className="text-[#49ba8e] text-xs">M-Ticket</div>
                    </div>
                    <div className="flex">
                      <svg
                        fill="#ffa426"
                      ...
                      <div className="text-[#ffa426] text-xs">
                        Food & Beverage
                      </div>
                    </div>
                  </div>
                ...
                <div
                  ...
                  className="px-6 py-2 border border-gray-400 rounded-md text-green-500 text-sm cursor-pointer"
                >
                  {cinema?.timing}
                </div>
              </div>
