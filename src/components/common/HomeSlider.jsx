  ...
  return (
    <div className='w-full h-max-h flex flex-col items-center justify-center bg-[rgb(245,245,245)]'>
        ...
        <ul className='flex items-center justify-center gap-5 text-[14px] font-sans font-[450] text-[rgb(51,51,51)]'>
                ...
                <li><NavLink>Streams</NavLink></li>
                <li><NavLink>Events</NavLink></li>
                <li><NavLink>Plays</NavLink></li>
           ...
           <ul className='flex items-center justify-center gap-5 text-[14px] font-sans font-[450] text-[rgb(51,51,51)]'>
                <li><NavLink>ListYourShow</NavLink></li>
                <li><NavLink>Corporates</NavLink></li>
        ...
        {
          <img src={sliderPictureArray[index].img} className='w-[90%] h-[300px] object-cover'></img>
        }
