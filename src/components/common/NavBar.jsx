    ...
    <div className="absolute left-1 top-1/2 transform -translate-y-1/2 text-gray-400">
      <GrFormSearch className="w-[30px] h-[25px]" />
        ...
        <div className="flex items-center justify-between gap-5">
          <button className="w-[67px] h-[25px] text-[13px] font-[500] text-center bg-[rgb(248,68,100)] text-white border-[rgb(248,68,100)] rounded-[4px] border-[1px]"><NavLink to="/login">Sign in</NavLink></button>
          <span>
