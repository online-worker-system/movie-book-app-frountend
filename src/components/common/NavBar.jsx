    ...
    <div className="w-full flex items-start justify-center py-5 px-5 md:px-7">
      <div className="w-full flex items-center justify-between">
        <div className="w-[60%] flex items-center gap-4">
          <NavLink
            to="/"
            className="flex items-center gap-1 justify-center text-[rgb(47,47,47)] text-sm sm:text-base lg:text-lg font-medium transform scale-y-150"
          >
            <h2>book</h2>
            <div className="bg-red-500 text-white rotate-12 inline-block">
              <div className="-rotate-12 w-[30px] h-[20px] lg:w-[32px] lg:h-[23px] flex items-center justify-center">
                <h2>my</h2>
              </div>
            </div>
            <h2>cinema</h2>
