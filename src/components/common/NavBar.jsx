      ...
      <div className="w-[95%] max-h-max flex items-center justify-between">
        <div className=" w-[60%] flex items-center justify-center gap-4">
          ...
          <div className="w-[75%] flex items-center justify-center">
            <input
              className="w-[100%] h-[34px] border-[rgb(238,238,238)] border-[1px] rounded-[4px] pl-3 outline-none font-sans"
              placeholder="Search for Movies,Events,Plays,Sports ans Activities"
            ></input>
          </div>
        </div>
