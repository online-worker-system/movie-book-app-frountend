...
// ------------------ get all movies API -------------------
export const getAllMoviesApi = createAsyncThunk('movie/getAllMovies', async (_, { rejectWithValue }) => {
  try {
...
export const { setLoading, setToken, clearError ,setAllMovies } = homeSlice.actions;
